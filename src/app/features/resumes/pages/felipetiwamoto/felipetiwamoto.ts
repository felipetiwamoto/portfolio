...
export class FelipeTiwamoto {
	...
	public experiences: Resume['experiences'] = [
		...
		},
		{
			...
			responsabilities: [
				$localize`:@@felipetiwamoto_: Ensinar programação (Projeto Lovelace)`,
				$localize`:@@felipetiwamoto_: Fazer palestras.`,
				$localize`:@@felipetiwamoto_: Distribuir cobertores.`,
				$localize`:@@felipetiwamoto_: Distribuir alimentos.`,
				$localize`:@@felipetiwamoto_: Dar aula de música.`,
				$localize`:@@felipetiwamoto_: Auxiliar na mudança das pessoas.`,
				$localize`:@@felipetiwamoto_: Música e Teatro ao ar livre.`,
			],
			description: $localize`:@@felipetiwamoto_: Atuação em iniciativas comunitárias, incluindo ensino de programação, realização de palestras educativas, distribuição de cobertores e alimentos para pessoas em situação de vulnerabilidade, aulas de música, apoio em mudanças residenciais e participação em apresentações de música e teatro ao ar livre, contribuindo para educação, cultura e apoio social.`,
		},
	];
}
