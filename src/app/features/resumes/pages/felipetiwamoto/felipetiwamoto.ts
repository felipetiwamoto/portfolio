...
export class FelipeTiwamoto {
	...
	public languages: Resume['skills'] = [
		{ name: 'Português', level: 10 },
		{ name: 'Inglês', level: 6 },
		{ name: 'Japonês', level: 4 },
	];
	public courses: Resume['courses'] = [
		{ institution: 'Faculdade Opet', name: 'Jogos Digitais (Técnico)', timeSpent: '1 ano' },
		{ institution: 'Udemy', name: 'Desenvolvimento Web', timeSpent: '54h' },
		{ institution: 'Udemy', name: 'Programação Reactiva', timeSpent: '17h' },
	...
	public experiences: Resume['experiences'] = [
		...
		},
		{
			...
			hardSkills: ['Cursos técnicos;'],
			description: `Liderança do time de front-end na criação de um novo projeto, atuando como desenvolvedor sênior com foco técnico e arquitetural. Mentoria de novos colaboradores e condução de palestras internas para capacitação do time no uso de tecnologias e boas práticas.`,
		},
		{
			company: 'Tuxon',
			startedAt: 'FEV 2020',
			...
			description: `Atuação na manutenção de sistemas existentes, desenvolvimento de novas funcionalidades e criação de projetos do zero. Perfil proativo, com forte capacidade analítica, habilidade para trabalhar sob pressão e boa comunicação para alinhamento técnico com o time.`,
		},
		{
		...
		},
		{
			...
			softSkills: ['Proatividade;', 'Capacidade de trabalhar sob pressão;', 'Capacidade analítica;'],
			hardSkills: ['Cursos técnicos;'],
			description: `Apesar da posição júnior, identifiquei a alta demanda de projetos e a dificuldade do time em manter o ritmo de entregas. Em alinhamento com o time de design, liderei a padronização dos componentes da empresa, criando variações reutilizáveis aplicadas em todos os novos projetos. Para viabilizar essa iniciativa, estudei profundamente frameworks como Bootstrap, Material e Semantic UI, desenvolvendo uma solução adaptada às necessidades da empresa, o que contribuiu para redução de horas extras e trabalho aos fins de semana.`,
		},
		{
			company: '01Tec',
			startedAt: 'ABR 2015',
			endedAt: 'SET 2016',
			responsabilities: ['Manutenção nos sistemas existentes.', 'Criação de novas funcionalidades.'],
			softSkills: ['Proatividade;', 'Capacidade analítica;'],
			hardSkills: ['Cursos técnicos;'],
			description: `Experiência de estágio onde iniciei com conhecimentos básicos em lógica de programação e evoluí para o desenvolvimento web completo, aprendendo HTML, CSS, JavaScript, jQuery, PHP e MySQL, além da criação de temas para WordPress. Após o período de estágio, atuei como freelancer para a empresa por alguns meses, contribuindo em projetos adicionais.`,
		},
		{
