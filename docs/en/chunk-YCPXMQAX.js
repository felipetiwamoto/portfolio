...
function V(s, c) {
	if ((s & 1 && (M(0, 'div'), k(1, 'img', 1), E()), s & 2)) {
		...
		(i(t('', g, '__left')),
			e(),
			i(t('', g, '__image')),
			X('alt', q((o = a.hero()) == null ? null : o.name))('src', (n = a.hero()) == null ? null : n.image, B));
	}
}
var F = class s {
	hero = v();
...
function Y(s, c) {
	if ((s & 1 && (r(0, 'li'), m(1, 'i-lucide', 1), r(2, 'span'), _(3), l()()), s & 2)) {
		let o = c.$implicit;
		f();
		let n = x(0);
		(i(t('', n, '__list_item')),
...
var U = class s {
	...
	static ɵcmp = u({
		...
		template: function (o, n) {
			if ((o & 1 && (S(0), r(1, 'div')(2, 'ul'), h(3, Y, 4, 13, 'li', 0, C), l()()), o & 2)) {
...
var W = class s {
	...
	static ɵcmp = u({
		...
		template: function (o, n) {
			if ((o & 1 && (S(0), r(1, 'div'), h(2, Z, 13, 35, 'div', 0, C), l()), o & 2)) {
...
var D = class s {
	...
	static ɵcmp = u({
		...
		vars: 6,
		template: function (o, n) {
			if ((o & 1 && (M(0, 'div')(1, 'span'), _(2), E()()), o & 2)) {
				let a,
					g = 'resume_about01';
...
function ee(s, c) {
	if ((s & 1 && k(0, 'li'), s & 2)) {
		let o = c.$index,
			...
			a = f(),
			g = x(0);
		i(J('', g, '__bullet_item ', a.isBulletItemActive(n, o + 1)));
	}
}
function ie(s, c) {
	if ((s & 1 && (M(0, 'li')(1, 'span'), _(2), E(), M(3, 'ul'), h(4, ee, 1, 4, 'li', 0, C), E()()), s & 2)) {
		let o = c.$implicit,
			n = f(),
			a = x(0);
		(i(t('', a, '__list_item')),
...
var N = class s {
	...
	static ɵcmp = u({
		...
		consts: [[3, 'class']],
		template: function (o, n) {
			if ((o & 1 && (S(0), M(1, 'div')(2, 'ul'), h(3, ie, 6, 10, 'li', 0, C), E()()), o & 2)) {
...
var G = class s {
	...
	static ɵcmp = u({
		...
		template: function (o, n) {
			if ((o & 1 && (S(0), r(1, 'div')(2, 'ul'), h(3, te, 13, 37, 'li', 0, C), l()()), o & 2)) {
...
var Q = class s {
	...
	static ɵcmp = u({
		...
		template: function (o, n) {
			if (
				(o & 1 &&
					(r(0, 'div')(1, 'div')(2, 'div')(3, 'div')(4, 'div'),
					m(5, 'resume-hero01', 7),
					l(),
					r(6, 'div'),
					m(7, 'resume-contacts01', 8),
					l()(),
					r(8, 'div')(9, 'div')(10, 'div')(11, 'div'),
					m(12, 'i-lucide', 9),
					r(13, 'span'),
					P(14, 0),
					l()(),
					m(15, 'resume-experiences01', 10),
					l()(),
					r(16, 'div')(17, 'div')(18, 'div'),
					m(19, 'i-lucide', 11),
					r(20, 'span'),
					P(21, 1),
					l()(),
					m(22, 'resume-about01', 12),
					l(),
					r(23, 'div')(24, 'div'),
					m(25, 'i-lucide', 13),
					r(26, 'span'),
					...
					P(42, 5),
					l(),
					m(43, 'resume-skills01', 14),
					l(),
					r(44, 'div')(45, 'span'),
					P(46, 6),
					l(),
					m(47, 'resume-skills01', 14),
					l()()()()()()()),
				o & 2)
			) {
				let a = 'resume';
...
export { Q as FelipeTiwamoto }; /**i18n:d38b4b21f8fda6d02c34a6c806d976a048c81b998d0927fcb3e158fe8fc47675*/
